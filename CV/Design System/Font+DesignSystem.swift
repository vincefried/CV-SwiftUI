...
extension Font {
    static let cvExtraLarge = Font.system(size: 22, weight: .semibold, design: .monospaced)
    static let cvLarge = Font.system(size: 16, weight: .semibold, design: .monospaced)
    ...
    static let cvIcon = Font.system(size: 22, weight: .medium)
}
